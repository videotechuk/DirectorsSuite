#pragma once
// Auto-generated from peds.lua. Do not edit by hand. See SceneData.cpp.
namespace SceneEmbedded {
inline const char* const Peds[] = {
"a_c_alligator_01",
"a_c_alligator_02",
"a_c_alligator_03",
"a_c_armadillo_01",
...
inline constexpr int PedsCount = (int)(sizeof(Peds) / sizeof(Peds[0]));
}
